...
#define MAX_ACTUATORS 	1
#define MAX_ASSIGNMENTS MAX_ACTUATORS + 1	// max number of assignments you can make. Every actuator needs to have at least one.
#define VALUE_CHANGE_TOLERANCE 0.001			// min difference between value and old value to consider a change in actuator.
